...
<div class="container-fluid">
	<h4 class="pt-5 pb-2">Add Product</h4>
  <div style="float: right; margin-top: -50px;">
	...
	<form action="sql/add_product.php" method="POST" enctype="multipart/form-data"> 
		<div class="row" style="overflow-y:scroll; height: 450px;">
					...
					<div class="col-12">
						<div class="row ">
							<div class="col-md-6 col-sm-12 mt-3">
								...
								<input type="text" name="category" placeholder="Product Category" class="form-control" required>
							</div>
                ...
                <input type="number" name="price" class="form-control" placeholder="Enter Price">
						...
						<div class="row mt-3 pb-4">
							<div class="col-12">
								...
								<textarea name="description" rows="5" cols="68" class="form-control" placeholder="Enter Your Description"></textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row mt-4 ">
				<div class="col-12 col-md-6">
					<input type="submit" name="add" value="Add Product" class="btn btn-primary ml-2">
				</div>
			</div>
		</div>
	</div>
