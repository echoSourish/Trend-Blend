...
<div class="container-fluid">
    ...
    <div style="float:right!important; margin-top: -30px;">
        <a href="product.php" class="btn btn"
            style="background-color: hsl(200, 87%, 62%); border-radius: 0px; color: #fff;">Add Product</a>
    </div>
    <hr>
                        ...
                        if (mysqli_num_rows($table) > 0) {
                            while ($row = mysqli_fetch_assoc($table)) {
                                ...
                                <tr>
                                    ...
                                    <td> <img src="img/<?php echo $row['product_image']; ?>" height="45px" width="45px"
                                            class="mt-1"></td>
